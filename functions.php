...
register_sidebar( array(
		'name'          => __( 'Front Page Widgets 1', 'joshua' ),
                'description'   => __( 'Front page widgets on the front page to display the property search.', 'joshua' ),
		'id'            => 'front_page_widget_area1',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
...
register_sidebar( array(
		'name'          => __( 'Front Page Widgets 2', 'joshua' ),
                'description'   => __( 'Front page widgets on the front page to display the property search.', 'joshua' ),
		'id'            => 'front_page_widget_area2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
...
register_sidebar( array(
		'name'          => __( 'Front Page Widgets 3', 'joshua' ),
                'description'   => __( 'Front page widgets on the front page to display the property search.', 'joshua' ),
		'id'            => 'front_page_widget_area3',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
